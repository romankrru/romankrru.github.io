...
gulp.task('scripts', function () {
  return gulp.src(['source/js/swiper.min.js', 'source/js/wow.js', 'source/js/main.js'])
...
gulp.task('watch', ['browser-sync', 'sass', 'scripts', 'svg-icons'], function () {
  gulp.watch('source/scss/**/*.scss', ['sass']);
  gulp.watch('source/*.html', ['html']);
  gulp.watch('source/js/main.js', ['scripts']); 
  gulp.watch('source/img/svg-icons/*.svg', ['svg-icons']);
});
...
gulp.task('build', ['sass', 'scripts', 'img', 'svg-icons'] ,function() {
